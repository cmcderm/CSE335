...
#include "../Project4_fix/databaseform.h"
...
QT_MOC_LITERAL(1, 13, 6), // "newRow"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 13), // "accept_f_name"
QT_MOC_LITERAL(4, 35, 21) // "on_addRButton_clicked"

    },
    "DatabaseForm\0newRow\0\0accept_f_name\0"
    "on_addRButton_clicked"
};
...
void DatabaseForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_addRButton_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (DatabaseForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DatabaseForm::newRow)) {
                *result = 0;
            }
        }
        {
            typedef void (DatabaseForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DatabaseForm::accept_f_name)) {
                *result = 1;
            }
        }
    }
